(function() {
	tinymce.create('tinymce.plugins.buttonPlugin', {
		init : function(ed, url) {
			...
			ed.addCommand('mcebuttonpages', function() {
			     jQuery('.shortbox:visible').fadeOut();
                jQuery('#droppages').fadeToggle();
			});
            ...
            ed.addButton('startis_pages', {title : 'Pages', cmd : 'mcebuttonpages' });    
            ed.addButton('startis_icons', {title : 'Icons', cmd : 'mcebuttonicons' });   
                ...
                jQuery('#droppages li li').unbind();
                jQuery('#droppages li li').bind('click', function() {
                    licont = jQuery(this).find('span').html();
                    tinyMCE.activeEditor.selection.setContent(licont);
                     jQuery('.shortbox:visible').fadeOut();
                });
	...
	//tinymce.PluginManager.add('startis_columns', tinymce.plugins.buttonPlugin);
