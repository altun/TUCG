    ...
    if (get_option('ls_alternative_area')!=='') { 
       ...
       '.do_shortcode(get_option("ls_call_us_top")).'
        ...
        <ul class="contactform">
    				...
    				<li><input onClick="callme();" type="submit" value="'.__('Submit').'" tabindex="5" id="submit" class="bigbutton" name="submit"></li>
    			</ul>
                <div id="callme_close" class="bigbutton"><i class="icon-remove"></i> '.__('Close').'</div>';
    }
    echo '</div></div>';
