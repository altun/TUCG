...
function startis_demo_panel(){
	...
	<div id="demo-panel">
		<div id="demo-panel-main"> 
			<a id="demo-close" href="#"><span></span></a>
			<div id="demo-inner">
                ...
                <h4 class="demo-title">Predefined Skins</h4>
                <div class="clear"></div>
                <?php $predefined_colors = array('19AFE5','95C343','1D83B9','8572c1','9d6e48','456399','FA3800','37B7D9','8dc563','ac68aa','FA2020','85bb27','667384','1aa54c','336699','F95601');
                        for ( $i=0; $i<=15;  ) { ?>
                           <a class="demo-pc-setting" id="demo-pc-color<?php echo $i; ?>" href="#" data-rel="<?php echo $predefined_colors[$i]; ?>" title="#<?php echo $predefined_colors[$i]; ?>"><span class="demo-pc-overlay"></span></a>
                <?php $i++; } ?>     
