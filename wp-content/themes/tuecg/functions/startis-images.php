			...
			$output = '<div class="portfolio_item"><a title="'.get_the_title($postid).'" href="'.stripslashes(htmlspecialchars_decode(get_post_meta($postid, 'ls_embed_code', true))).'">
                '.$thumb.'</a>
                       <span class="bgoverlay">
                            ...
                            <a href="'.get_permalink($postid).'"><i class="icon-link"></i></a> 
                            <a class="mpp" data-effect="mfp-zoom-in" title="'.get_the_title($postid).'" data-rel="magnific" href="'.stripslashes(htmlspecialchars_decode(get_post_meta($postid, 'ls_embed_code', true))).'"><i class="icon-play-sign"></i></a> 
                          </span></div>';
        }
			else
		{  //
			$output = '<div class="portfolio_item" ><a title="'.get_the_title($postid).'" href="'.$link.'">
                '.$thumb.'</a>
                       <span class="bgoverlay">
                            <span class="coverlay"></span>
                            <a href="'.get_permalink($postid).'"><i class="icon-link"></i></a> 
                            <a class="mpp" data-effect="mfp-zoom-in" title="'.get_the_title($postid).'" data-rel="magnific" href="'.$link.'"><i class="icon-zoom-in"></i></a> 
                          </span></div>';
		}
