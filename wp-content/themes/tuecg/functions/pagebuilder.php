...
require_once 'pagebuilder_admin.php';
	...
	function pb_new_modules_init(){
		...
		$pb_modules['blog_posts'] = array(
			...
			'options' => array(
				...
				'style' => array(
					'title' => __('Blog Posts Style', 'startis'),
					'type' => 'select',
					'options' => array('1', '2'),
					'std' => '1'
				),
        ...
        $pb_columns['1_1'] = array( 'name' => __('Close Section', 'startis') );
